...
class RegResult(models.Model):
    ...
    src = models.CharField(u'源路径', max_length=1000, default='')
    template = models.CharField(u'模板路径', max_length=1000, default='')
    config = models.CharField(u'配置路径', max_length=1000, default='')
